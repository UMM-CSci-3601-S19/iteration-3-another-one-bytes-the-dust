...
public class RideController {
  ...
  String getRides(Map<String, String[]> queryParams){
    ...
    if (queryParams.containsKey("visible")) {
      String key = "visible";
      filterDoc = appendFilterDocBoolean(queryParams, key, filterDoc);
    }
    System.err.println("I got past visible");
  ...
  String addNewRide(String driver, String destination, String origin, Boolean roundTrip, Boolean driving, String departureDate,
                    String departureTime, String notes, String sortDateTime, Boolean noSmoking, Boolean Eco, Boolean petFriendly, Boolean visible) {
    ...
    newRide.append("visible", visible);
    ...
    try {
      ...
      System.err.println("Successfully added new ride [_id=" + _id + ", driver=" + driver + ", destination=" + destination + ", origin=" + origin + ", roundTrip=" + roundTrip + ", driving="
        ...
        " sortDateTime=" + sortDateTime + " noSmoking=" + noSmoking + " Eco=" + Eco + "petFriendly=" + petFriendly + "visible=" + visible + ']');
  ...
  Boolean updateRide(String id, String driver, String destination, String origin, Boolean roundTrip, Boolean driving,
    String departureDate, String departureTime, String notes, String sortDateTime, Boolean noSmoking, Boolean Eco, Boolean petFriendly, Boolean visible){
    ObjectId objId = new ObjectId(id);
    ...
    updateFields.append("visible" , visible);
