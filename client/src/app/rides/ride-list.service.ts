...
export class RideListService {
  ...
  getRides(searchedDestination: string, searchedOrigin: string, searchedDate: string, searchedTime: string, searchedRoundTrip: boolean, searchSort?: string): Observable<Ride[]> {
